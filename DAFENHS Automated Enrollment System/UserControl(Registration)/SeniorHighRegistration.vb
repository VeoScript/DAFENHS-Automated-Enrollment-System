...
Public Class SeniorHighRegistration
    ...
    Private Sub cmbRegisterAs_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    'For the Registration of Senior High Student 
    Private Sub btnRegister_Click(sender As Object, e As EventArgs) Handles btnRegister.Click
        ...
        Try
            ...
            Else
                ...
                search = "SELECT LRN FROM StudentRegistration_SeniorHighschool WHERE LRN='" & txtLRN.Text & "'"
        ...
        End Try
    End Sub 
    'End For the Registration of Senior High Student
